...
NSString *const MJRefreshFooterRefreshing = @"CJ哥正在帮你加载数据...";

NSString *const MJRefreshHeaderPullToRefresh = @"下拉可以刷新";
NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即刷新";
NSString *const MJRefreshHeaderRefreshing = @"CJ哥正在帮你刷新...";
NSString *const MJRefreshHeaderTimeKey = @"CJRefreshHeaderView";
